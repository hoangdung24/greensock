      ...
      <div className="panels" id="panelContainer">
        ...
        <div className="panel two" id="panel_2">
          <div className="clip">
            ...
            <span className="tint" />
            <img src="https://source.unsplash.com/1920x1080?ocean" alt="" />
          </div>
        </div>
        <div className="panel three" id="panel_3">
          <div className="clip">
            ...
            <span className="tint" />
            <img src="https://source.unsplash.com/1920x1080?river" alt="" />
          </div>
        </div>
        <div className="panel four" id="panel_4">
          <div className="clip">
            ...
            <span className="tint" />
            <img src="https://source.unsplash.com/1920x1080?waterfall" alt="" />
          </div>
        </div>
        <div className="panel five" id="panel_5">
          <div className="clip">
            ...
            <span className="tint" />
            <img src="https://source.unsplash.com/1920x1080?glacier" alt="" />
          </div>
        </div>
        <div className="panel six" id="panel_6">
          <div className="clip">
            ...
            <span className="tint" />
            <img src="https://source.unsplash.com/1920x1080?snow" alt="" />
          </div>
        </div>
      </div>
    </div>
